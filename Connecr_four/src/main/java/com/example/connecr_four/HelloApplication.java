package com.example.connecr_four;
...
public class HelloApplication extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Mirza Ismail Beg");
        alert.setContentText("Hi! I am Mirza Ismail Beg ,a web developer focused on crafting great\n" +
